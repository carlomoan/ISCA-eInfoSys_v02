document.addEventListener('DOMContentLoaded', function () {
    ...
    exportPdfBtn?.addEventListener('click', async (e) => {
        ...
        // Logos
        const leftIcon = await getBase64Image('/assets/images/nimr_logo_gen.png');
        const rightIcon = await getBase64Image('/assets/images/Survey_img_1_-Upd.png');
        ...
        // Footer
        const fullName = labDataObj['lab_tech_name'] || 'Unknown';
