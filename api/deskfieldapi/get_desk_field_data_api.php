...
$userId = $_SESSION['user_id'];  // Hii ndiyo inatumika ku-filter data
...
try {
    $query = "SELECT * FROM desk_field_collector WHERE 1=1";
    $params = [];

    // Sasa tuna-filter kulingana na session user_id
